classdef msotData < handle
    ...
    properties ( SetAccess = private )
        ...
        MeasurementDesc@struct scalar = struct(); % Does not appear when calling obj in constructor
        HWDesc@struct scalar = struct();          % Does not appear when calling obj in constructor
        USpresent@logical scalar = false;
        US@struct scalar;
        OAMPreset@struct scalar = struct();
        RepNum@uint16 scalar;                    % Does not appear when calling obj in constructor
        RunNum@uint16 scalar;                    % Does not appear when calling obj in constructor
        ShotNum@uint16 scalar;                   % Does not appear when calling obj in constructor
        AverageTemperature@single scalar;        % Does not appear when calling obj in constructor
        
        ScanFrames@scanFrame vector;             % Does not appear when calling obj in constructor
        ...
        ZPositions@single vector;                % Does not appear when calling obj in constructor
        Timestamps@double vector;                % Does not appear when calling obj in constructor
